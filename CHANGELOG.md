...
- Manually set borders for pre-processing continuous values into categories in body-tracking modality
- Class weights for supervised loss in bio-measurements modality
...
- Class weights for supervised loss in bio-measurements modality
- Manually set borders for pre-processing continuous values into categories in bio-measurements modality

### Changed
- Minor fixes in bio-measurements pre-processing to account for some data format issues from Magic XRoom
