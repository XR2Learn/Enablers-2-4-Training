...
from supervised_bm_modality.supervised_dataset import SupervisedDataModule
from supervised_bm_modality.utils.init_utils import init_augmentations, init_transforms


class SupervisedDatasetDataModuleTestCase(unittest.TestCase):
    def setUp(self) -> None:
        self.data_path = tempfile.mkdtemp()
        # 1d features: (if implemented later) handcrafted features
        self.dataset_size = 1000
        self.input_size_1d = (1, 20)
        ...
        # 2d features: pre-processed time-series (num_channels, num_timestamps)
        self.input_size_2d = (6, 100)
    ...
    def test_supervised_datamodules__transforms_augmentations(self):
        sys.path.append("./supervised_bm_modality/")
        cfg_transforms = {
            "transforms": [
                {
                    "class_name": "ToTensor",
