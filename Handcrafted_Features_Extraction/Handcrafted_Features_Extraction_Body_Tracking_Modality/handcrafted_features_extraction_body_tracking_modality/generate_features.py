...
from conf import CUSTOM_SETTINGS, DATA_PATH, MODALITY, MODALITY_FOLDER, EMOTION_TO_LABEL
...
def call_component():
    ...
    # 3.Range of Motion 
    window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["rom_win_size"]  # Define the size of the window for the local range of motion
    ...
    def calculate_jerk(pos_data):
        ...
        return jerk / (time_intervals ** CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["jerk_time_interval"])
    ...
    def calculate_correlation(pos_data1, pos_data2):
        ...
        window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["correlation_win_size"]  
    ...
    def calculate_psd(pos_data, fs, nperseg=CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["psd_sample_per_segment"], noverlap=CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["psd_sample_segment_overlap"]):
    ...
    window_length = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["psd_win_len"]  # Length of the window for PSD calculation
    overlap = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["psd_win_len_overlap"]
    ...
    window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["stat_win_size"]  # Length of the window for calculations
    overlap = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["stat_win_size_overlap"]   # Number of overlapping data points
    # store statistics
    ...
    # Parameters for sliding window
    window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["fft_win_size"]  # Length of the window for FFT calculation
    overlap = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["fft_win_size_overlap"]  # Number of overlapping data points
    ...
    # Parameters for sliding window
    window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["sym_win_size"]  # Length of the window for symmetry calculation
    overlap = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["sym_win_size_overlap"]       # Number of overlapping data points
    ...
    # Parameters for sliding window
    window_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["harmo_win_size"]  # Length of the window for harmonic analysis
    overlap = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["harmo_win_size_overlap"]   # Number of overlapping data points
    ...
    # Segment size
    segment_size = CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["frame_segment_size"]
    ...
    X_train, X_temp, y_train_encoded, y_temp_encoded = train_test_split(
      X_flattened, y_segmented, test_size=CUSTOM_SETTINGS[MODALITY]["handcrafted_feature_extraction"]["test_size"], random_state=42, stratify=y_segmented)
