...
from ssl_features_extraction_bm_modality.utils.init_utils import init_encoder, init_transforms
from ssl_features_extraction_bm_modality.generate_and_save import generate_and_save
...
class InitTransformsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        stride = 2
        self.cnn_config = {
            "from_module": "ssl_features_extraction_bm_modality.encoders.cnn1d",
            "class_name": "CNN1D",
            "kwargs": {
