...
from .base_augmentations import GaussianNoise,Reverse,SignFlip,ChannelFlip,Scale,ZeroMasking,NoAugmentation
...
def compose_random_augmentations(config_dict):
    ...
    """
    #all augmentations assume channel first, and no batch, input shape: [channels, dataseries]
    augmentations_dict = {
